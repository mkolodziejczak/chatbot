...
/***************************************
  ...
  ***************************************/
  ...
  #define('_SESSION_PATH_', _ADMIN_PATH_ . 'ses_07c84151e39a9bc93de8114d04a82a51' . $path_separator);
  ...
  $dbn    = 'AIML';    # dev database name/prefix
  $dbu    = 'databaseLogin';       # dev database username
  $dbp    = 'databasePass';  # dev database password
  //these are the admin DB settings in case you want make the admin a different db user with more privs
  $adm_dbu = 'adminPanelLogin';
  $adm_dbp = 'adminPanelPass';
  ...
  $error_response = 'What do you mean?';
